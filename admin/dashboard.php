...
<div class="page-wrapper chiller-theme toggled">
  ...
  <main class="page-content">
    <div class="container-fluid">
      ...
      <div class="row">
            <div class="col-md-4">
                <div class="card text-white mb-3 bg-info" style="max-width: 15rem;">
            ...
            <div class="col-md-4">
                <div class="card text-white mb-3 bg-warning" style="max-width: 15rem;">
            ...
            <div class="col-md-4">
                <div class="card text-white mb-3 bg-danger" style="max-width: 15rem;">
