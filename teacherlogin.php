...
if(isset($_POST['username']) && isset($_POST['password']) && isset($_POST['submit']))
{
    ...
    $result = $con->query("SELECT * FROM teacher WHERE username = '$usename' AND password = '$password'");
    if($result-> num_rows > 0){
        ...
        exit;
            ...
            echo ("<script LANGUAGE='JavaScript'>
                ...
                window.location.href='http://localhost:8888/OnlineExam/teacherlogin.php';
                </script>");
        }
    ...
    //         window.location.href='http://localhost:8888/OnlineExam/teacherdashboard.php';
    //         </script>");
    // }
    // else {
    //     echo ("<script LANGUAGE='JavaScript'>
...
<body class="about-page">
    ...
    <form class="form" action="" method="post" name="login">
		...
		<div class="form-group">
            ...
            <p class="link">Login As??<a href="login.php">Student</a></p>
        </div>
    </form>
    </div>
    </div>
